...
export default function About() {
  return (
    <div className="bg-surface font-body text-on-surface antialiased">
      ...
      <section className="relative min-h-[85vh] flex items-center overflow-hidden bg-surface-container-lowest">
        ...
        <div className="container-max relative z-10 w-full pt-16">
          ...
          >
            ...
            <h1 className="text-2xl sm:text-6xl md:text-8xl lg:text-[8rem] font-black text-on-surface tracking-tighter leading-[1.1] mb-6 md:mb-8">
              Engineering <br/><span className="text-gradient">Absolute Trust.</span>
            </h1>
            <p className="text-base md:text-xl text-on-surface-variant leading-relaxed max-w-3xl font-medium opacity-80">
        ...
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-16 lg:gap-24 items-center">
            <div className="lg:col-span-7">
              <h2 className="text-2xl sm:text-4xl md:text-6xl lg:text-7xl font-black tracking-tight mb-6 md:mb-8 leading-[1.1]">Empowering Financial Innovation through <span className="text-gradient">Absolute Precision.</span></h2>
              <div className="space-y-6 md:space-y-10 text-base md:text-xl text-on-surface-variant leading-relaxed font-medium opacity-80">
            ...
            <div className="lg:col-span-5">
              <div className="glass-card p-8 md:p-12 lg:p-16 rounded-[2rem] md:rounded-[4rem] border-l-[8px] md:border-l-[16px] border-primary shadow-2xl shadow-primary/5">
                <ShieldCheck className="text-primary mb-6 md:mb-10 w-12 h-12 md:w-20 md:h-20" />
                <h3 className="text-xl md:text-3xl font-black mb-4 md:mb-8 tracking-tight">Our Commitment</h3>
      ...
      <section className="section-padding bg-surface-container-low">
        <div className="container-max">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <motion.div 
              whileHover={{ y: -10 }}
              className="md:col-span-2 glass-card p-8 md:p-12 lg:p-16 rounded-[2rem] md:rounded-[4rem] group shadow-xl hover:shadow-2xl transition-all duration-500"
            >
              <div className="w-14 h-14 md:w-20 md:h-20 bg-primary/10 rounded-2xl md:rounded-3xl flex items-center justify-center mb-8 md:mb-12 text-primary group-hover:bg-primary group-hover:text-white transition-all duration-500">
                <Shield className="w-7 h-7 md:w-10 md:h-10" />
              </div>
              <h3 className="text-3xl md:text-5xl font-black mb-6 md:mb-10 tracking-tight">Trust</h3>
              <p className="text-base md:text-xl text-on-surface-variant font-medium leading-relaxed max-w-2xl opacity-75 group-hover:opacity-100 transition-opacity">The bedrock of our relationship with global financial institutions. We operate as an extension of your security perimeter, ensuring total data sovereignty.</p>
            </motion.div>
            <motion.div 
              whileHover={{ y: -10 }}
              className="orange-gradient p-8 md:p-12 lg:p-16 rounded-[2rem] md:rounded-[4rem] text-white shadow-2xl shadow-primary/20 flex flex-col justify-between group overflow-hidden"
            >
              ...
              <div className="relative z-10">
                <FlaskConical className="text-white w-12 h-12 md:w-16 md:h-16 mb-8 md:mb-12" />
                <h3 className="text-3xl md:text-4xl font-black mb-6 md:mb-8 tracking-tight">Precision</h3>
                <p className="text-base md:text-lg text-white/80 font-medium leading-relaxed">Surgical accuracy in every script, every test case, and every automated flow. We leave no room for ambiguity.</p>
              </div>
            </motion.div>
            <motion.div 
              whileHover={{ y: -10 }}
              className="bg-slate-900 p-8 md:p-12 lg:p-16 rounded-[2rem] md:rounded-[4rem] text-white flex flex-col justify-between group overflow-hidden"
            >
              <div className="absolute inset-0 bg-grid-white opacity-5 group-hover:scale-110 transition-transform duration-1000"></div>
              <div className="relative z-10">
                <Gavel className="text-primary w-12 h-12 md:w-16 md:h-16 mb-8 md:mb-12" />
                <h3 className="text-3xl md:text-4xl font-black mb-6 md:mb-8 tracking-tight">Compliance</h3>
            ...
            <motion.div 
              whileHover={{ y: -10 }}
              className="md:col-span-2 glass-card p-8 md:p-12 lg:p-16 rounded-[2rem] md:rounded-[4rem] flex flex-col md:flex-row items-center gap-8 md:gap-12 group transition-all duration-500"
            >
              <div className="flex-1">
                <div className="w-12 h-12 md:w-16 md:h-16 bg-primary/10 rounded-2xl flex items-center justify-center mb-8 md:mb-10 text-primary group-hover:bg-primary group-hover:text-white transition-all duration-500">
                  <Lightbulb className="w-6 h-6 md:w-8 md:h-8" />
                </div>
                <h3 className="text-3xl md:text-4xl font-black mb-6 md:mb-8 tracking-tight">Innovation</h3>
                <p className="text-base md:text-xl text-on-surface-variant font-medium leading-relaxed opacity-75">Continuously evolving our methodologies to match the speed of fintech disruption. From DLT to Open Banking.</p>
              </div>
              <div className="shrink-0 w-full md:w-96 h-48 md:h-80 rounded-[2rem] md:rounded-[4rem] overflow-hidden grayscale group-hover:grayscale-0 transition-all duration-[2s] shadow-2xl border-2 border-white/20">
                <img 
                  alt="Innovation" 
      ...
      <section className="section-padding bg-surface">
        <div className="container-max">
          <div className="orange-gradient rounded-[2.5rem] md:rounded-[5rem] p-8 md:p-16 lg:p-24 text-center relative overflow-hidden shadow-2xl shadow-primary/20">
            <div className="absolute inset-0 opacity-10 pointer-events-none bg-grid-white"></div>
            <div className="relative z-10 max-w-5xl mx-auto">
              <h2 className="text-2xl sm:text-4xl md:text-6xl lg:text-8xl font-black text-white leading-tight mb-8 md:mb-12 tracking-tight">Secure your digital future with the laboratory of <span className="italic">BFSI testing.</span></h2>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-8">
                <Link to="/contact" className="bg-white text-primary px-8 md:px-14 py-4 md:py-6 rounded-2xl font-black text-base md:text-xl hover:scale-105 transition-all shadow-2xl shadow-black/10 inline-block w-full sm:w-auto">Initiate Consultation</Link>
                <Link to="/contact" className="border-2 border-white/30 text-white px-8 md:px-14 py-4 md:py-6 rounded-2xl font-black text-base md:text-xl hover:bg-white/10 transition-all w-full sm:w-auto inline-block text-center">Request Portfolio</Link>
              </div>
            </div>
          </div>
        </div>
