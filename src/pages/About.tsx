  ...
  return (
    <div className="bg-surface font-body text-on-surface antialiased">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden bg-slate-50 pt-20">
        ...
        <div className="max-w-7xl mx-auto px-16 relative z-10 w-full">
          <motion.div 
          ...
          >
            ...
            <h1 className="text-6xl md:text-9xl font-black text-on-surface tracking-tighter leading-[0.85] mb-12">
        ...
        <div className="max-w-7xl mx-auto px-16">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-24 items-center">
            <div className="lg:col-span-7">
              <h2 className="text-5xl font-black tracking-tighter mb-10 leading-tight">Empowering Financial Innovation through <span className="text-primary italic">Absolute Precision.</span></h2>
            ...
            <div className="lg:col-span-5">
              <div className="bg-slate-50 p-12 rounded-[3rem] border-l-8 border-primary shadow-xl shadow-slate-200">
      ...
      <section className="py-32 bg-slate-50 overflow-hidden">
        <div className="max-w-7xl mx-auto px-16">
          <div className="mb-24">
            <label className="text-[10px] font-black tracking-[0.3em] uppercase text-primary mb-4 block">Our Journey</label>
            <h2 className="text-5xl font-black tracking-tighter">Legacy of Innovation</h2>
          </div>
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <motion.div 
              whileHover={{ y: -10 }}
              className="md:col-span-2 bg-slate-50 p-16 rounded-[4rem] hover:bg-slate-100 transition-all border border-slate-100 group shadow-sm hover:shadow-2xl"
            >
              ...
              <p className="text-xl text-slate-600 font-medium leading-relaxed max-w-xl">The bedrock of our relationship with global financial institutions. We operate as an extension of your security perimeter, ensuring total data sovereignty.</p>
            </motion.div>
            <motion.div 
              whileHover={{ y: -10 }}
              className="bg-primary p-16 rounded-[4rem] text-white shadow-2xl shadow-primary/30 flex flex-col justify-between"
            >
              <div>
                <FlaskConical className="text-white w-16 h-16 mb-12" />
                <h3 className="text-4xl font-black mb-8 tracking-tighter">Precision</h3>
                <p className="text-lg text-blue-50 font-medium opacity-80 leading-relaxed">Surgical accuracy in every script, every test case, and every automated flow. We leave no room for ambiguity.</p>
              </div>
            </motion.div>
            <motion.div 
              whileHover={{ y: -10 }}
              className="bg-slate-900 p-16 rounded-[4rem] text-white flex flex-col justify-between"
            >
              <div>
            ...
            <motion.div 
              whileHover={{ y: -10 }}
              className="md:col-span-2 bg-slate-50 p-16 rounded-[4rem] hover:bg-slate-100 transition-all border border-slate-100 flex flex-col md:flex-row items-center gap-16"
            >
              <div className="flex-1">
                <Lightbulb className="text-primary w-16 h-16 mb-12" />
                <h3 className="text-4xl font-black mb-8 tracking-tighter">Innovation</h3>
                <p className="text-xl text-slate-600 font-medium leading-relaxed">Continuously evolving our methodologies to match the speed of fintech disruption. From DLT to Open Banking.</p>
              </div>
      ...
      <section className="py-32 bg-slate-50">
        <div className="max-w-7xl mx-auto px-16">
          <div className="text-center mb-24">
            <label className="text-[10px] font-black tracking-[0.3em] uppercase text-slate-400 mb-4 block">The Visionaries</label>
            <h2 className="text-5xl font-black tracking-tighter">Laboratory Leadership</h2>
          </div>
      ...
      <section className="py-24 bg-white border-y border-slate-100">
        <div className="max-w-7xl mx-auto px-16">
          <div className="flex flex-wrap items-center justify-between gap-12 opacity-30 grayscale hover:opacity-100 hover:grayscale-0 transition-all duration-1000">
            {[
      ...
      <section className="py-32 bg-white px-8">
        <div className="max-w-7xl mx-auto px-16">
          <div className="orange-gradient rounded-[4rem] p-24 text-center relative overflow-hidden shadow-[0px_32px_128px_rgba(0,64,223,0.3)]">
            <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-white/10 rounded-full blur-[120px] -mr-64 -mt-64"></div>
            <div className="relative z-10">
              <h2 className="text-5xl md:text-7xl font-black text-white leading-[1] mb-12 max-w-4xl mx-auto tracking-tighter italic">Secure your digital future with the laboratory of BFSI testing.</h2>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-8">
                <Link to="/contact" className="bg-white text-primary px-12 py-6 rounded-2xl font-black text-lg hover:scale-105 transition-all shadow-2xl inline-block">Initiate Consultation</Link>
                <button className="border-2 border-white/30 text-white px-12 py-6 rounded-2xl font-black text-lg hover:bg-white/10 transition-all">Download Portfolio</button>
              </div>
            </div>
          </div>
        </div>
