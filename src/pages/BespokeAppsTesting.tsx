          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col lg:flex-row gap-16 items-center">
              <div className="flex-1 grid grid-cols-2 gap-4">
                <img className="rounded-3xl shadow-lg" src="https://images.unsplash.com/photo-1558494949-ef010cbdcc51?auto=format&fit=crop&q=80&w=400" alt="Server Room" referrerPolicy="no-referrer" />
                <img className="rounded-3xl shadow-lg mt-8" src="https://images.unsplash.com/photo-1563986768609-322da13575f3?auto=format&fit=crop&q=80&w=400" alt="Dashboard" referrerPolicy="no-referrer" />
              </div>
              <div className="flex-1">
