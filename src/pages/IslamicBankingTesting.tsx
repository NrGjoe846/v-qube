    ...
    <div className="flex min-h-screen bg-surface">
      ...
      <main className="flex-1">
          ...
          <div className="container-max w-full relative z-10 py-24">
            <div className="max-w-3xl">
              ...
              >
                ...
                <h1 className="text-3xl md:text-6xl font-black text-on-surface tracking-tighter leading-[1.2] mb-8">
                  Shariah-Compliant <br className="hidden sm:block" /><span className="text-gradient italic">Precision Testing.</span>
                </h1>
                <p className="text-lg md:text-xl text-on-surface-variant leading-relaxed max-w-2xl font-medium opacity-80 mb-12">
          ...
          <div className="container-max w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
              {/* Murabaha & Ijarah Logic */}
                ...
                viewport={{ once: true }}
                className="md:col-span-8 bg-white p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] shadow-sm border border-slate-200 relative overflow-hidden group"
              >
                ...
                <div className="w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-primary/5 flex items-center justify-center text-primary mb-8 border border-primary/10">
                  <Scale className="w-8 h-8" />
                </div>
                <h3 className="text-2xl md:text-3xl font-black text-slate-900 mb-6 tracking-tight">Murabaha & Ijarah Validation</h3>
                <p className="text-slate-600 text-base md:text-lg leading-relaxed mb-10 font-medium max-w-2xl">
              ...
              {/* Takaful Ecosystems */}
                ...
                className="md:col-span-4 bg-primary p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] text-white flex flex-col justify-between shadow-xl shadow-primary/20"
              >
                <div>
                  <div className="w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-white/10 flex items-center justify-center text-white mb-8 border border-white/20">
                    <Users className="w-8 h-8" />
                  </div>
                  <h3 className="text-2xl md:text-3xl font-black mb-6 tracking-tight">Takaful Ecosystems</h3>
                  <p className="text-blue-100 text-base md:text-lg leading-relaxed mb-8 font-medium">
              ...
              >
                <div className="bg-white p-8 md:p-16 rounded-[2rem] md:rounded-[2.4rem] flex flex-col lg:flex-row items-center gap-10 md:gap-16">
                  <div className="flex-1 space-y-6 md:space-y-8">
                    ...
                    <h3 className="text-2xl md:text-4xl font-black text-slate-900 tracking-tight leading-tight">Shariah Governance Modules</h3>
          ...
          <div className="container-max w-full relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
              {[
                ...
                >
                  <div className="text-5xl md:text-8xl font-black text-white/5 absolute -top-8 md:-top-12 -left-4 md:-left-8 transition-all group-hover:text-primary/10 group-hover:-top-16">
                    {item.step}
                  </div>
                  <div className="w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-primary/20 flex items-center justify-center text-primary mb-6 md:mb-8 border border-primary/30">
                    {item.icon}
                  </div>
                  <h4 className="text-xl md:text-2xl font-black mb-3 md:mb-4 tracking-tight">{item.title}</h4>
        ...
        <section className="py-20 bg-white">
          <div className="orange-gradient p-10 md:p-24 rounded-[2rem] md:rounded-[3rem] flex flex-col items-center text-center text-white relative overflow-hidden shadow-2xl shadow-primary/30">
            <div className="absolute inset-0 opacity-10 pointer-events-none bg-grid-orange"></div>
            <h3 className="text-2xl md:text-6xl font-black mb-8 z-10 tracking-tighter leading-[1.1] md:leading-tight">Secure Your Shariah Framework</h3>
            <p className="text-lg md:text-xl text-white/80 max-w-2xl mb-10 md:mb-12 z-10 font-medium">Deploy our dedicated Islamic Banking testing laboratory for your next implementation or audit cycle.</p>
            <div className="flex flex-col sm:flex-row gap-4 md:gap-6 z-10">
              <Link to="/contact" className="bg-white text-primary px-10 md:px-12 py-4 md:py-5 rounded-2xl font-black text-base md:text-lg hover:bg-slate-50 transition-all shadow-xl">
                Request a Consultation
              </Link>
              <Link to="/testing" className="border-2 border-white/30 text-white px-10 md:px-12 py-4 md:py-5 rounded-2xl font-black text-base md:text-lg hover:bg-white/10 transition-all">
                View All Domains
              </Link>
            </div>
          </div>
