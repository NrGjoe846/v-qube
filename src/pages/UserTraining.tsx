...
const sidebarLinks = [
  ...
  { name: "Training & Rollout", icon: <Rocket className="w-5 h-5" />, path: "/services/support-users", active: true },
];
      ...
      <section className="py-32 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 md:px-16">
          <div className="flex flex-col lg:flex-row items-center gap-24">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-12 tracking-tighter">The "Pristine Training" Methodology</h2>
        ...
        <div className="max-w-5xl mx-auto px-6 md:px-16 relative z-10 text-center">
          <div className="bg-primary rounded-[3rem] p-16 md:p-24 shadow-2xl shadow-primary/30 text-white relative overflow-hidden">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6">
              <Link to="/contact" className="bg-white text-primary px-10 py-5 rounded-2xl font-black text-lg hover:bg-slate-50 transition-all">
